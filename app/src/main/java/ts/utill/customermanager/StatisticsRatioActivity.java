...
public class StatisticsRatioActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		textView_statistics_ratio_preiod.setOnClickListener(new TextView.OnClickListener(){
			public void onClick(View arg0) {
				...
				button_statistics_dialog_term_ratio_1.setOnClickListener(new Button.OnClickListener(){
					public void onClick(View arg0) {
						Calendar startCal = Calendar.getInstance();
				...
				button_statistics_dialog_term_ratio_2.setOnClickListener(new Button.OnClickListener(){
					public void onClick(View arg0) {
						Calendar startCal = Calendar.getInstance();
						Calendar endCal = Calendar.getInstance();
				...
				button_statistics_dialog_term_ratio_3.setOnClickListener(new Button.OnClickListener(){
					public void onClick(View arg0) {
						Calendar startCal = Calendar.getInstance();
						Calendar endCal = Calendar.getInstance();
				...
				button_statistics_dialog_term_ratio_4.setOnClickListener(new Button.OnClickListener(){
					public void onClick(View arg0) {
						Calendar startCal = Calendar.getInstance();
						Calendar endCal = Calendar.getInstance();
						...
						.setPositiveButton(R.string.setting,new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog, int which) {
								...
								if (checkBox_statitics_dialog_term_ratio_all.isChecked()) {
									...
									textView_statistics_ratio_preiod.setText("전체");
									...
									if(startcal.getTimeInMillis() - endcal.getTimeInMillis() > 0){
										Toast.makeText(StatisticsRatioActivity.this, "기간설정이 잘못되었습니다.", Toast.LENGTH_SHORT).show();
									}else{
		...
		textView_statistics_ratio_title.setText(spinner_statistics_ratio_article.getSelectedItem().toString() + "별 " + spinner_statistics_ratio_option.getSelectedItem().toString());
		...
		imageView_statistics_ratio_search.setOnClickListener(new ImageView.OnClickListener(){
			@Override
			...
			if(statistics_Ratio_Record.getValue() > 0 ){
				...
				switch (selected_article) {
					case 0: case 3: case 5:
						...
						break;
					case 1:
						if(statistics_Ratio_Record.getName() == "남성"){
	...
	private ArrayList<Statistics_Ratio_Record> getStatistics_Sex_Amount(Calendar firstDate, Calendar lastDate){
		...
		if (stat_amount[0] > stat_amount[1]) {
			array.add(new Statistics_Ratio_Record("남성", stat_amount[0]));
			array.add(new Statistics_Ratio_Record("여성", stat_amount[1]));
		}else{
			array.add(new Statistics_Ratio_Record("여성", stat_amount[1]));
			array.add(new Statistics_Ratio_Record("남성", stat_amount[0]));
		}
	...
	private ArrayList<Statistics_Ratio_Record> getStatistics_Sex_Count(){
		...
		if (stat_value[0] > stat_value[1]) {
			array.add(new Statistics_Ratio_Record("남성", stat_value[0]));
			array.add(new Statistics_Ratio_Record("여성", stat_value[1]));
		}else{
			array.add(new Statistics_Ratio_Record("여성", stat_value[1]));
			array.add(new Statistics_Ratio_Record("남성", stat_value[0]));
		}
	...
	private ArrayList<Statistics_Ratio_Record> getStatistics_Age_Amount(Calendar firstDate, Calendar lastDate){
		...
		for (int i : index) {
			array.add(new Statistics_Ratio_Record(i*10+10+"대", stat_amount[i]));
		}
	...
	private ArrayList<Statistics_Ratio_Record> getStatistics_Age_Count(){
		...
		for (int i : index) {
			array.add(new Statistics_Ratio_Record(i*10+10+"대", stat_value[i]));
		}
