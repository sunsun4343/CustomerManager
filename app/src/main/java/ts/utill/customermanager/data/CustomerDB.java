...
public class CustomerDB {
	...
	//to About
	private final int version = 2; //db����
	...
	public void ConvertDB(Context context){
		...
		Toast.makeText(context, "DB ������Ʈ�� �����մϴ�.", Toast.LENGTH_SHORT).show();
		...
		Toast.makeText(context, "DB�� �ҷ��ɴϴ�.", Toast.LENGTH_SHORT).show();
		...
		try {
			Toast.makeText(context, "�ҷ��� DB��  CSV���Ϸ� ����մϴ�.", Toast.LENGTH_SHORT).show();
			...
			Toast.makeText(context, "DB�� ��ȯ�մϴ�.", Toast.LENGTH_SHORT).show();
		...
		builder.setMessage("DB ��ȯ �Ϸ�");
		
		Toast.makeText(context, "DB������Ʈ�� �Ϸ�Ǿ����ϴ�.", Toast.LENGTH_SHORT).show();
	}
	...
	public void CSVExport(Context context, String filename) {
		try {
			...
			Toast.makeText(context, "Save " + CustomerDB.filepath + filename + ".csv\n"
					...
					+"��ǰ " + itemlist.size() + "�� "
					+"�з�" + grouplist.size() + "�� "
					+"���� " + salelist.size() + "���� ����Ǿ����ϴ�.", Toast.LENGTH_LONG).show();
			
			
		} catch (Throwable t) {
			Toast.makeText(context, "������ �߻��Ͽ� �������� ���߽��ϴ�. �����ڿ��� ���� �ϼ���. \n" + "Err " + t.toString(), Toast.LENGTH_LONG).show();
